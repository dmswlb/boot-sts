...
//보조 업무_로그를 남김
//Aspect: Pointcut 과 Advise를 합쳐 놓은 코드(업무 보조)
//Advise: 조인 포인트에 삽입되어 동작할 수 있는 공통 관심 사항의 코드
//aspect 실제 구현체
//*동작 시점:조인포인트 실행 전, 후로 before, after, after returning, after throwing, around로 구분
...
public class LoggingAdvice{
	...
	public void aa() {}		//메서드 이름은 상관없음, 메서드형태를 만들고 @Pointcut 작성
	...
	public Object aroundMethod2(ProceedingJoinPoint jp) throws Throwable {
		...
		//1.around
		//2.before
		System.out.println("[around]=========LongginAdvice보조업무=========");
		System.out.println(jp.getSignature().getName()+"메서드 호출전[around]");
		//3주업무
		...
		//5.after
		//6.around
		System.out.println(jp.getSignature().getName()+"메서드 호출후[around]");
